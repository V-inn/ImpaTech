...
sheet["A1"] = "Tempo (s)"
sheet["B1"] = "Lado Frio (°C)"
sheet["C1"] = "Lado Quente (°C)"
    ...
    while True:
        if arduino.in_waiting > 0:
            try:
                ...
                print(f"Leitura {i-1}: T: {tempo:.0f} | Quente: {temperatura1:.2f} °C | Frio: {temperatura2:.2f}")
                sheet["A"+str(i)] = tempo
                sheet["B"+str(i)] = temperatura1
                sheet["C"+str(i)] = temperatura2
